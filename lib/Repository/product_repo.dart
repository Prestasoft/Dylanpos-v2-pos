        ...
        for (var element in snapshot.children) {
          ...
          if (element.value is Map<dynamic, dynamic>) {
            ...
            if (mapValue.containsKey('accountName') && mapValue.containsKey('bankName')) {
              ...
              (element.value is Map && (element.value as Map).isEmpty) ||
              (element.value is String && (element.value as String).isEmpty) ||
              (element.value is List && (element.value as List).isEmpty)) {
