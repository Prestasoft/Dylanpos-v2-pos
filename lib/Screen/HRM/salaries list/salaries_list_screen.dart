                ...
                children: [
                  ...
                  salary.when(data: (employeeList) {
                    ...
                    for (var element in reverseAllIncomeCategory) {
                      if (searchItem != '' && (element.employeeName.toLowerCase().contains(searchItem.toLowerCase()) || element.designation.toLowerCase().contains(searchItem.toLowerCase()))) {
                                  ...
                                  employee.when(
                                    data: (employees) {
                                      return ElevatedButton.icon(
                                        ...
                                        icon: const Icon(FeatherIcons.plus, color: kWhite, size: 20.0),
                                        label: Text(
                                          'Pay Salary',
                                                  ...
                                                  child: DataTable(
                                                    ...
                                                    rows: List.generate(
                                                      ...
                                                      (index) => DataRow(cells: [
                                                        ...
                                                        DataCell(
                                                          Text(
                                                            paginatedList[index].employeeName,
                                                          ),
                                                        ),
                                                        DataCell(
                                                          Text(
                                                            paginatedList[index].paySalary.toString(),
                                                          ),
                                                        ),
                                                        DataCell(
                                                          Text(
                                                                ...
                                                                PopupMenuItem(
                                                                  onTap: () async {
                                                                    ...
                                                                    if (await showDeleteConfirmationDialog(context: context, itemName: 'salary')) {
                                                                      bool result = await SalaryRepository().deletePaidSalary(id: paginatedList[index].id);
                                                                      if (result) {
