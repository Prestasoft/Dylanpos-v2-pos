                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style: Theme.of(context).textTheme.titleMedium?.copyWith(color: kGreyTextColor, fontWeight: FontWeight.w600),
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                ElevatedButton(
                                                    ...
                                                    onPressed: (() async {
                                                      if (validateAndSave()) {
                                                        try {
                                                          ...
                                                          EasyLoading.show(status: lang.S.of(context).sendingResetEmail);
                                                          ...
                                                          EasyLoading.showSuccess(lang.S.of(context).pleaseCheckYourInbox);
                                                          if (!mounted) return;
                                                          context.go(EmailLogIn.route);
                                                          // Navigator.pushNamed(context, EmailLogIn.route);
                                                        } on FirebaseAuthException catch (e) {
                                                          if (e.code == 'user-not-found') {
                                                            // EasyLoading.showError('No user found for that email.');
                                                            EasyLoading.showError('${lang.S.of(context).noUserFoundForThatEmail}.');
                                                    ...
                                                    child: Text(lang.S.of(context).resetYourPassword)),
                                              ],
                                            ),
                                          ),
                                        ],
