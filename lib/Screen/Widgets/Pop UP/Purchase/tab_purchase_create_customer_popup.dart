...
/// Popup para crear un nuevo proveedor (versión Tablet) - Usa PostgreSQL API
class TabPurchaseCreateCustomerPopUp extends StatefulWidget {
  const TabPurchaseCreateCustomerPopUp({Key? key}) : super(key: key);

  @override
  State<TabPurchaseCreateCustomerPopUp> createState() => _TabPurchaseCreateCustomerPopUpState();
}

class _TabPurchaseCreateCustomerPopUpState extends State<TabPurchaseCreateCustomerPopUp> {
  ...
  Future<void> _saveSupplier(WidgetRef ref) async {
    ...
    try {
      ...
      debugPrint('[TabPurchaseCreateCustomerPopUp] Error: $e');
  ...
  Widget build(BuildContext context) {
    return Consumer(
      builder: (context, ref, _) {
        return SizedBox(
          width: 600, // Tamaño reducido para tablet
          child: Column(
