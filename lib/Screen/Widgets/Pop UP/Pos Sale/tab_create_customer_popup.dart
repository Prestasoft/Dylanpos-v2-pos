...
/// Popup para crear un nuevo cliente (versión Tablet) - Usa PostgreSQL API
class TabCreateCustomerPopUp extends StatefulWidget {
  const TabCreateCustomerPopUp({Key? key}) : super(key: key);

  @override
  State<TabCreateCustomerPopUp> createState() => _TabCreateCustomerPopUpState();
}

class _TabCreateCustomerPopUpState extends State<TabCreateCustomerPopUp> {
  ...
  Future<void> _saveCustomer(WidgetRef ref) async {
    ...
    try {
      ...
      print('[TabCreateCustomerPopUp] Error: $e');
