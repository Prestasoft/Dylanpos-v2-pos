...
class AreasEquipmentsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AreasEquipmentsScreen> createState() => _AreasEquipmentsScreenState();
}

class _AreasEquipmentsScreenState extends ConsumerState<AreasEquipmentsScreen> with SingleTickerProviderStateMixin {
                  ...
                  child: Column(
                    children: [
                      TabBar(
                        ...
                        tabs: [
                          Tab(icon: const Icon(Icons.map), text: lang.S.of(context).areas),
                          Tab(icon: const Icon(Icons.devices_other), text: lang.S.of(context).equipments),
                        ],
                      ),
                    ],
                  ),
        ...
        return equipmentsAsync.when(
          ...
          data: (equipments) {
            ...
            for (var equipment in equipments) {
              areaCounts.update(equipment.areaId, (value) => value + 1, ifAbsent: () => 1);
            }
            ...
            return Column(
              children: [
                            ...
                            child: Theme(
                              ...
                              child: DataTable(
                                ...
                                columns: [
                                  ...
                                  DataColumn(label: Text(lang.S.of(context).description)),
                                  DataColumn(label: Text(lang.S.of(context).quantityItems)),
                                    ...
                                    DataCell(Row(
                                      children: [
                                        ...
                                        IconButton(
                                          ...
                                          onPressed: () async {
                                            final confirm = await _confirmDelete('${lang.S.of(context).deleteAreaConfirm}');
                                            if (confirm) await ref.read(areasProvider.notifier).deleteArea(area.id);
                                          },
                                        ),
                                      ],
                                    )),
                ...
                if (filtered.isEmpty) noDataFoundImage(text: lang.S.of(context).noDataFound),
              ],
            );
          },
        );
        ...
        data: (areas) {
          var filtered = equipments.where((e) =>
            (e.name.toLowerCase().contains(_searchQuery.toLowerCase()) ||
             e.areaName.toLowerCase().contains(_searchQuery.toLowerCase())) &&
          ...
          final totalQty = filtered.fold<int>(0, (sum, item) => sum + item.quantity);
          final totalValue = filtered.fold<double>(0.0, (sum, item) => sum + (item.quantity * item.price));
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: ConstrainedBox(
                          ...
                          child: Theme(
                            ...
                            child: DataTable(
                              border: const TableBorder(horizontalInside: BorderSide(width: 1, color: kNeutral300)),
                              dataRowColor: const WidgetStatePropertyAll(Colors.white),
                              headingRowColor: WidgetStateProperty.all(const Color(0xFFF8F3FF)),
                              showBottomBorder: false,
                              dividerThickness: 0.0,
                              ...
                              columns: [
                                ...
                                DataColumn(label: Text(lang.S.of(context).area)),
                                DataColumn(label: Text(lang.S.of(context).totalValue)),
                              ...
                              rows: List.generate(paginated.length, (i) {
                                ...
                                return DataRow(cells: [
                                  ...
                                  DataCell(Text(myFormat.format(e.price * e.quantity))),
                                  DataCell(
                                    Container(
                                  ...
                                  DataCell(Row(
                                    children: [
                                      IconButton(
                                        ...
                                        onPressed: () async {
                                          final confirm = await _confirmChangeState(
                                      ...
                                      IconButton(
                                        icon: const Icon(Icons.edit, color: kMainColor),
                                        onPressed: () => _showEquipmentDialog(equipment: e, areas: areas),
                                      ),
                                      IconButton(
                                        icon: const Icon(Icons.delete, color: Colors.red),
                                        onPressed: () async {
                                          ...
                                          if (confirm) await ref.read(equipmentsProvider.notifier).deleteEquipment(e.id);
                                        },
                                      ),
                                    ],
                                  )),
        ...
        child: Container(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text(
                  area == null ? lang.S.of(context).addArea : lang.S.of(context).editArea,
                  style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18),
                ),
                const SizedBox(height: 20),
                TextFormField(
                  controller: nameController,
                  decoration: InputDecoration(labelText: lang.S.of(context).name),
                  validator: (value) {
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(labelText: lang.S.of(context).description),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
  ...
  Future<void> _showEquipmentDialog({Equipment? equipment, List<Area>? areas}) async {
    ...
    final priceController = TextEditingController(text: equipment?.price.toString() ?? '0');
    final qtyController = TextEditingController(text: equipment?.quantity.toString() ?? '0');
        ...
        child: Container(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text(
                  equipment == null ? lang.S.of(context).addEquipment : lang.S.of(context).editEquipment,
                  style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18),
                ),
                const SizedBox(height: 20),
                TextFormField(
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(labelText: lang.S.of(context).price),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                ...
                TextFormField(
                  ...
                  keyboardType: TextInputType.number,
                  decoration: InputDecoration(labelText: lang.S.of(context).quantity),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration: InputDecoration(labelText: lang.S.of(context).area),
                  validator: (value) {
                    if (value == null) {
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        if (formKey.currentState!.validate()) {
                          ...
                          final notifier = ref.read(equipmentsProvider.notifier);
                          equipment == null 
